import { _ as R, n as f, $ as E, a0 as oe, X as T, a1 as C, a2 as P, a3 as ae, a4 as A, a5 as U, w as L, a6 as y, a7 as ue, c as ce, a8 as k, a9 as M, aa as D, ab as H, ac as de, ad as he, ae as pe, af as z, ag as F, T as w, o as B, ah as le, ai as fe } from "./app2.js";
import { l as ge, a as me } from "./colorToUniform.js";
import { c as _e, u as be, U as ye, B as xe, G as Ge, e as Be, R as Se, t as Pe, S as Te, a as Ce } from "./SharedSystems.js";
const x = R.for2d();
class O {
  start(e, t, r) {
  ...
  _createVertexBufferLayouts(e, t) {
    ...
    return e.buffers.forEach((i) => {
      ...
      for (const u in t.attributeData) {
        ...
        (c.divisor ?? 1) !== 1 && L(`Attribute ${u} has an invalid divisor value of '${c.divisor}'. WebGPU only supports a divisor value of 1`), c.buffer === i && (n.arrayStride = c.stride, n.stepMode = c.instance ? "instance" : "vertex", o.push({
...
class Z {
  constructor() {
    this.defaultState = new R(), this.defaultState.blend = !0;
  }
  contextChange(e) {
    this.gpu = e;
  }
  ...
  execute(e, t) {
    ...
    for (let _ = 0; _ < u.instructionSize; _++) {
      ...
      if (m.topology !== d && (d = m.topology, c.setPipelineFromGeometryProgramAndState(
        ...
        const S = m.textures;
        m.bindGroup = E(S.textures, S.count), m.gpuBindGroup = i.bindGroup.getBindGroup(
          m.bindGroup,
          s.gpuProgram,
          1
        );
...
class re {
  ...
  execute(e, t) {
    ...
    if (!s)
      ...
      L("Mesh shader has no gpuProgram", t.shader);
      return;
    }
