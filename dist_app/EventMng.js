import { k as re, l as st, C as J, H as be, j as ge, aH as we, b as K, S as St, B as xe } from "./app2.js";
...
var _ = "top", T = "bottom", H = "right", L = "left", Lt = "auto", ut = [_, T, H, L], tt = "start", lt = "end", Ee = "clippingParents", ie = "viewport", at = "popper", De = "reference", Xt = /* @__PURE__ */ ut.reduce(function(r, t) {
  return r.concat([t + "-" + tt, t + "-" + lt]);
}, []), ne = /* @__PURE__ */ [].concat(ut, [Lt]).reduce(function(r, t) {
  return r.concat([t, t + "-" + tt, t + "-" + lt]);
}, []), Ce = "beforeRead", Se = "read", Pe = "afterRead", _e = "beforeMain", Le = "main", Re = "afterMain", $e = "beforeWrite", je = "write", Me = "afterWrite", Te = [Ce, Se, Pe, _e, Le, Re, $e, je, Me];
function N(r) {
...
function He(r) {
  ...
  Object.keys(t.elements).forEach(function(e) {
    ...
    !M(a) || !N(a) || (Object.assign(a.style, i), Object.keys(n).forEach(function(s) {
      var o = n[s];
...
function Be(r) {
  ...
  return Object.assign(t.elements.popper.style, e.popper), t.styles = e, t.elements.arrow && Object.assign(t.elements.arrow.style, e.arrow), function() {
    Object.keys(t.elements).forEach(function(i) {
      ...
      !M(n) || !N(n) || (Object.assign(n.style, o), Object.keys(a).forEach(function(f) {
        n.removeAttribute(f);
      }));
    });
  };
...
function rt(r, t, e) {
  ...
  t && M(r) && (n = r.offsetWidth > 0 && et(i.width) / r.offsetWidth || 1, a = r.offsetHeight > 0 && et(i.height) / r.offsetHeight || 1);
...
function zt(r) {
  return !M(r) || // https://github.com/popperjs/popper-core/issues/837
...
function Ne(r) {
  ...
  var n = kt(r);
  for (Rt(n) && (n = n.host); M(n) && ["html", "body"].indexOf(N(n)) < 0; ) {
    var a = A(n);
...
function qe(r) {
  ...
  if (!(!a || !s)) {
    var h = Ve(n.padding, e), m = $t(a), d = f === "y" ? _ : L, c = f === "y" ? T : H, u = e.rects.reference[l] + e.rects.reference[f] - s[f] - e.rects.popper[l], v = s[f] - e.rects.reference[f], k = dt(a), b = k ? f === "y" ? k.clientHeight || 0 : k.clientWidth || 0 : 0, O = u / 2 - v / 2, y = h[d], w = b - m[l] - h[c], g = b / 2 - m[l] / 2 + O, x = ft(y, g, w), C = f;
    e.modifiersData[i] = (t = {}, t[C] = x, t.centerOffset = x - g, t);
  }
}
function Ue(r) {
...
function Kt(r) {
  ...
  d = v.x, u = v.y;
  var k = s.hasOwnProperty("x"), b = s.hasOwnProperty("y"), O = L, y = _, w = window;
  if (p) {
    var g = dt(e), x = "clientHeight", C = "clientWidth";
    if (g === $(e) && (g = q(e), A(g).position !== "static" && o === "absolute" && (x = "scrollHeight", C = "scrollWidth")), g = g, n === _ || (n === L || n === H) && a === lt) {
      y = T;
      var D = h && g === w && w.visualViewport ? w.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        g[x]
      );
    ...
    if (n === L || (n === _ || n === T) && a === lt) {
      O = H;
      var E = h && g === w && w.visualViewport ? w.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        g[C]
      );
      d -= E - i.width, d *= f ? 1 : -1;
  ...
  if (d = B.x, u = B.y, f) {
    var P;
    return Object.assign({}, S, (P = {}, P[y] = b ? "0" : "", P[O] = k ? "0" : "", P.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + d + "px, " + u + "px)" : "translate3d(" + d + "px, " + u + "px, 0)", P));
  }
  return Object.assign({}, S, (t = {}, t[y] = b ? u + "px" : "", t[O] = k ? d + "px" : "", t.transform = "", t));
}
function ze(r) {
...
function Je(r) {
  ...
  return a && p.forEach(function(l) {
    l.addEventListener("scroll", e.update, gt);
  }), o && f.addEventListener("resize", e.update, gt), function() {
    a && p.forEach(function(l) {
      l.removeEventListener("scroll", e.update, gt);
    }), o && f.removeEventListener("resize", e.update, gt);
  };
}
const Ge = {
  name: "eventListeners",
...
function Tt(r) {
  return rt(q(r)).left + Mt(r).scrollLeft;
}
function tr(r, t) {
...
function er(r) {
  var t, e = q(r), i = Mt(r), n = (t = r.ownerDocument) == null ? void 0 : t.body, a = G(e.scrollWidth, e.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0), s = G(e.scrollHeight, e.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0), o = -i.scrollLeft + Tt(r), f = -i.scrollTop;
...
function le(r) {
  return ["html", "body", "#document"].indexOf(N(r)) >= 0 ? r.ownerDocument.body : M(r) && Ht(r) ? r : le(kt(r));
}
function ct(r, t) {
  var e;
  t === void 0 && (t = []);
...
function ir(r) {
  var t = ct(kt(r)), e = ["absolute", "fixed"].indexOf(A(r).position) >= 0, i = e && M(r) ? dt(r) : r;
...
function pt(r, t) {
  t === void 0 && (t = {});
  var e = t, i = e.placement, n = i === void 0 ? r.placement : i, a = e.strategy, s = a === void 0 ? r.strategy : a, o = e.boundary, f = o === void 0 ? Ee : o, p = e.rootBoundary, l = p === void 0 ? ie : p, h = e.elementContext, m = h === void 0 ? at : h, d = e.altBoundary, c = d === void 0 ? !1 : d, u = e.padding, v = u === void 0 ? 0 : u, k = fe(typeof v != "number" ? v : ce(v, ut)), b = m === at ? De : at, O = r.rects.popper, y = r.elements[c ? b : m], w = nr(Z(y) ? y : y.contextElement || q(r.elements.popper), f, l, s), g = rt(r.elements.reference), x = pe({
    reference: g,
    element: O,
    strategy: "absolute",
    placement: n
  }), C = _t(Object.assign({}, O, x)), D = m === at ? C : g, E = {
...
function sr(r) {
  ...
  if (!t.modifiersData[i]._skip) {
    for (var n = e.mainAxis, a = n === void 0 ? !0 : n, s = e.altAxis, o = s === void 0 ? !0 : s, f = e.fallbackPlacements, p = e.padding, l = e.boundary, h = e.rootBoundary, m = e.altBoundary, d = e.flipVariations, c = d === void 0 ? !0 : d, u = e.allowedAutoPlacements, v = t.options.placement, k = W(v), b = k === v, O = f || (b || !c ? [wt(v)] : ar(v)), y = [v].concat(O).reduce(function(Q, V) {
    ...
    }, []), w = t.rects.reference, g = t.rects.popper, x = /* @__PURE__ */ new Map(), C = !0, D = y[0], E = 0; E < y.length; E++) {
      var S = y[E], B = W(S), P = it(S) === tt, U = [_, T].indexOf(B) >= 0, I = U ? "width" : "height", R = pt(t, {
        placement: S,
        boundary: l,
        rootBoundary: h,
        altBoundary: m,
...
function yr(r) {
  var t = r.state, e = r.options, i = r.name, n = e.mainAxis, a = n === void 0 ? !0 : n, s = e.altAxis, o = s === void 0 ? !1 : s, f = e.boundary, p = e.rootBoundary, l = e.altBoundary, h = e.padding, m = e.tether, d = m === void 0 ? !0 : m, c = e.tetherOffset, u = c === void 0 ? 0 : c, v = pt(t, {
    ...
    padding: h,
    altBoundary: l
  }), k = W(t.placement), b = it(t.placement), O = !b, y = jt(k), w = mr(y), g = t.modifiersData.popperOffsets, x = t.rects.reference, C = t.rects.popper, D = typeof u == "function" ? u(Object.assign({}, t.rects, {
    placement: t.placement
  })) : u, E = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
  ...
  if (g) {
    if (a) {
      var P, U = y === "y" ? _ : L, I = y === "y" ? T : H, R = y === "y" ? "height" : "width", F = g[y], ht = F + v[U], Y = F - v[I], vt = d ? -C[R] / 2 : 0, Ot = b === tt ? x[R] : C[R], nt = b === tt ? -C[R] : -x[R], mt = t.elements.arrow, Q = d && mt ? $t(mt) : {
        width: 0,
        height: 0
    ...
    if (o) {
      var Wt, me = y === "x" ? _ : L, ye = y === "x" ? T : H, z = g[w], bt = w === "y" ? "height" : "width", Nt = z + v[me], At = z - v[ye], Ct = [_, L].indexOf(k) !== -1, Vt = (Wt = S?.[w]) != null ? Wt : 0, qt = Ct ? Nt : z - x[bt] - C[bt] - Vt + E.altAxis, Ut = Ct ? z + x[bt] + C[bt] - Vt - E.altAxis : At, It = d && Ct ? Ae(qt, z, Ut) : ft(d ? qt : Nt, z, d ? Ut : At);
      g[w] = It, B[w] = It - z;
    }
    t.modifiersData[i] = B;
  }
...
function kr(r, t, e) {
  e === void 0 && (e = !1);
  var i = M(t), n = M(t) && xr(t), a = q(t), s = rt(r, n, e), o = {
    scrollLeft: 0,
    scrollTop: 0
  }, f = {
    x: 0,
  ...
  Ht(a)) && (o = wr(t)), M(t) ? (f = rt(t, !0), f.x += t.clientLeft, f.y += t.clientTop) : a && (f.x = Tt(a))), {
  ...
  return function(o, f, p) {
    ...
    var l = {
      ...
      setOptions: function(k) {
        var b = typeof k == "function" ? k(l.options) : k;
        u(), l.options = Object.assign({}, a, l.options, b), l.scrollParents = {
      ...
      forceUpdate: function() {
        if (!m) {
          var k = l.elements, b = k.reference, O = k.popper;
          if (ee(b, O)) {
            l.rects = {
              reference: kr(b, dt(O), l.options.strategy === "fixed"),
              popper: $t(O)
            ...
            for (var y = 0; y < l.orderedModifiers.length; y++) {
              ...
              var w = l.orderedModifiers[y], g = w.fn, x = w.options, C = x === void 0 ? {} : x, D = w.name;
    ...
    function c() {
      l.orderedModifiers.forEach(function(v) {
        var k = v.name, b = v.options, O = b === void 0 ? {} : b, y = v.effect;
...
var Pr = [Ge, vr, Ke, Fe, dr, fr, br, Ie, lr], _r = /* @__PURE__ */ Sr({
  defaultModifiers: Pr
});
class jr {
...
<div class="sn_hint" role="tooltip">
    ...
    this.#e.add(window, "languagechange", (c) => {
      l(), this.#r.fire("sn:chgNavLang", c), ge.cache.reset();
    }), l();
    const h = (c) => {
    ...
    "WheelEvent" in window && (this.#e.add(this.main.cvs, "wheel", (c) => this.#d(c), { passive: !0 }), this.#s = (c) => this.#e.add(c, "wheel", (u) => this.#d(u), { passive: !0 }), d = (c, u) => c.add(this.main.cvs, "wheel", (v) => {
      ...
      J.debugLog && (u.on("gamepad:connected", (b) => console.log(`👺<'gamepad:connected' index:${b.detail.index} id:${b.detail.gamepad.id}`)), u.on("gamepad:disconnected", (b) => console.log(`👺<'gamepad:disconnected' index:${b.detail.index} id:${b.detail.gamepad?.id}`)));
      const v = [
        "",
        "ArrowUp",
        "",
      ...
      u.on("gamepad:axis", (b) => {
        ...
        k[b.detail.axis] = b.detail.value;
        const [O = 0, y = 0] = k, w = (y + 1) * 3 + (O + 1), g = v[w];
        if (!g) return;
        const x = this.#t.getFocus();
        (!x || x instanceof st ? globalThis : x).dispatchEvent(new KeyboardEvent("keydown", { key: g, bubbles: !0 })), !(!x || x instanceof st) && x.getAttribute("type") === "range" && x.dispatchEvent(new InputEvent("input", { bubbles: !0 }));
      }), u.on("gamepad:button", (b) => {
