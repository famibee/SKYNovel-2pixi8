import { n as d, _ as C, a2 as T, w as m, X as b, aq as j, aB as Te, Q as Be, ag as G, T as S, c as K, a1 as p, R as M, a6 as B, a7 as L, a8 as U, ae as $, aa as z, aC as Y, aD as Ae, aE as Ne, aF as q, aG as ye, o as x, ah as Ie, ai as De } from "./app2.js";
import { b as Z } from "./colorToUniform.js";
import { e as Ce, G as Ge, c as Ue, b as Oe, U as Pe, R as Fe, B as Q, d as A, f as Me, S as Le, a as He } from "./SharedSystems.js";
class J {
  constructor() {
    this._didUpload = !1, this._tempState = C.for2d();
  }
  init(e) {
...
const O = class te {
  ...
  init(e) {
    ...
    if (e.context && r && (m("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."), r = !1), r ? this.canvas = b.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this.canvas = this._renderer.view.canvas, e.context)
  ...
  activateVao(e, r) {
    ...
    for (const o in i) {
      ...
      if (h) {
        ...
        const E = j(c.format), F = ke(c.format);
...
const We = new Te({
  ...
  init(e = {}) {
    ...
    this.useBackBuffer = r, this._antialias = s, this._renderer.context.supports.msaa || (m("antialiasing, is not supported on when using the back buffer"), this._antialias = !1), this._state = C.for2d();
    const n = new Be({
      vertex: `
...
class qe {
  ...
  initGpuRenderTarget(e) {
    const r = this._renderer, s = r.gl, n = new Ke();
  ...
  prerender(e) {
    ...
    this._renderer.context.multiView && L.test(r) && this._renderer.context.ensureCanvasSize(r);
  }
  postrender(e) {
    if (this._renderer.context.multiView && L.test(e.colorTexture.resource)) {
...
function it(t, e) {
  ...
  )), t.linkProgram(n), t.getProgramParameter(n, t.LINK_STATUS) || nt(t, n, r, s), e._attributeData = tt(
    n,
    t,
    !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex)
  ), e._uniformData = st(n, t), e._uniformBlockData = rt(n, t), t.deleteShader(r), t.deleteShader(s);
  const a = {};
...
function ut(t) {
  const e = {};
  if (e.normal = [t.ONE, t.ONE_MINUS_SRC_ALPHA], e.add = [t.ONE, t.ONE], e.multiply = [t.DST_COLOR, t.ONE_MINUS_SRC_ALPHA, t.ONE, t.ONE_MINUS_SRC_ALPHA], e.screen = [t.ONE, t.ONE_MINUS_SRC_COLOR, t.ONE, t.ONE_MINUS_SRC_ALPHA], e.none = [0, 0], e["normal-npm"] = [t.SRC_ALPHA, t.ONE_MINUS_SRC_ALPHA, t.ONE, t.ONE_MINUS_SRC_ALPHA], e["add-npm"] = [t.SRC_ALPHA, t.ONE, t.ONE, t.ONE], e["screen-npm"] = [t.SRC_ALPHA, t.ONE_MINUS_SRC_COLOR, t.ONE, t.ONE_MINUS_SRC_ALPHA], e.erase = [t.ZERO, t.ONE_MINUS_SRC_ALPHA], !(t instanceof b.get().getWebGLRenderingContext()))
...
function Bt(t, e) {
  let r = {}, s = t.RGBA;
  return t instanceof b.get().getWebGLRenderingContext() ? e.srgb && (r = {
...
class be {
  ...
  generateCanvas(e) {
    const { pixels: r, width: s, height: n } = this.getPixels(e), i = b.get().createCanvas();
