import { N as De, aj as Ee, a8 as ee, aa as v, W as Oe, Q as Fe, n as d, o as E, ak as te, _ as He, al as g, am as Le, an as y, ai as O, ao as F, ap as re, q as ze, T as m, a1 as f, a6 as U, w as se, aq as $, ar as We, a3 as q, a2 as k, a7 as A, as as M, c as S, R as w, at as Ve, E as Ne, l as P, au as ae, av as ne, aw as ie, ax as oe, z as le, ay as je, P as $e, a4 as qe, m as K, X as de, az as Y, d as Ke, v as Ye, aA as Je } from "./app2.js";
import { B as ue, c as Xe } from "./colorToUniform.js";
import { R as Qe } from "./RenderTexture.js";
var Ze = `in vec2 vMaskCoord;
...
class tt extends De {
  constructor(e) {
    const { sprite: t, ...r } = e, a = new Ee(t.texture), n = new ee({
...
const H = class ce {
  constructor(e, t) {
    this.state = He.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, this._adaptor.init?.(this);
  }
  static getBatcher(e) {
  ...
  buildEnd(e) {
    ...
    for (const r in t) {
      const a = t[r], n = a.geometry;
      n.indexBuffer.setDataWithSize(a.indexBuffer, a.indexSize, !0), n.buffers[0].setDataWithSize(a.attributeBuffer.float32View, a.attributeSize, !1);
    }
  }
  upload(e) {
    ...
    for (const r in t) {
      const a = t[r], n = a.geometry;
      a.dirty && (a.dirty = !1, n.buffers[0].update(a.attributeSize * 4));
    }
  }
  execute(e) {
...
let he = H;
E.handleByMap(d.Batcher, he._availableBatchers);
E.add(te);
const At = {
  name: "texture-bit",
  vertex: {
...
function rt(s, e) {
  ...
  r.reset();
  const a = e.renderPipes ? e : e.batch.renderer, n = a.renderPipes;
  n.batch.buildStart(r), n.blendMode.buildStart(), n.colorMask.buildStart(), t.sortableChildren && t.sortChildren(), fe(t, r, a, !0), n.batch.buildEnd(r), n.blendMode.buildEnd(r);
}
function R(s, e, t) {
  const r = t.renderPipes ? t : t.batch.renderer;
  s.globalDisplayStatus < 7 || !s.includeInBuild || (s.sortableChildren && s.sortChildren(), s.isSimple ? st(s, e, r) : fe(s, e, r, !1));
}
function st(s, e, t) {
  if (s.renderPipeId) {
    const r = s, { renderPipes: a, renderableGC: n } = t;
    a.blendMode.setBlendMode(r, s.groupBlendMode, e), a[r.renderPipeId].addRenderable(r, e), n.addRenderable(r), r.didViewUpdate = !1;
  }
  if (!s.renderGroup) {
...
function fe(s, e, t, r) {
  const { renderPipes: a, renderableGC: n } = t;
  if (!r && s.renderGroup)
    a.renderGroup.addRenderGroup(s.renderGroup, e);
  else {
    ...
    o && (a.blendMode.setBlendMode(i, i.groupBlendMode, e), a[o].addRenderable(i, e), n.addRenderable(i), i.didViewUpdate = !1);
    const l = s.children;
    if (l.length)
...
class pe {
  ...
  execute(e) {
    ...
    if (e.action === "pushMaskBegin") {
      ...
      r && (t.type === O.WEBGL && t.renderTarget.finishRenderPass(), t.renderTarget.pop(), t.globalUniforms.pop()), t.filter.push({
        renderPipeId: "filter",
        action: "pushFilter",
      ...
      r && y.returnTexture(a.filterTexture), g.return(a.filterEffect);
    }
  }
  destroy() {
...
class ve {
  ...
  push(e, t, r) {
    ...
    l.instructionsStart = r.instructionSize, R(
      o,
      r,
      i
  ...
  execute(e) {
    ...
    e.action === "pushMaskBegin" ? (r.renderTarget.ensureDepthStencil(), r.stencil.setStencilMode(f.RENDERING_MASK_ADD, n), n++, r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, n) : r.stencil.setStencilMode(f.MASK_ACTIVE, n), r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0), n !== 0 ? r.stencil.setStencilMode(f.RENDERING_MASK_REMOVE, n) : (r.renderTarget.clear(null, U.STENCIL), r.stencil.setStencilMode(f.DISABLED, n)), n--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, n) : r.stencil.setStencilMode(f.MASK_ACTIVE, n), r.colorMask.setMask(15)), this._maskStackHash[a] = n;
  }
  destroy() {
...
function it(s) {
  ...
  for (const n in t) {
    const i = t[n];
    i.stride ?? (i.stride = r[i.buffer.uid]), i.start ?? (i.start = a[i.buffer.uid]), a[i.buffer.uid] += $(i.format).stride;
  }
}
const _ = [];
_[f.NONE] = void 0;
...
class Dt {
  ...
  _initUniformGroup(e) {
    ...
    if (!r) {
      const a = Object.keys(e.uniformStructures).map((o) => e.uniformStructures[o]), n = this._adaptor.createUboElements(a), i = this._generateUboSync(n.uboElements);
  ...
  syncUniformGroup(e, t, r) {
    ...
    let n = null;
    return t || (t = e.buffer.data, n = e.buffer.dataInt32), r || (r = 0), a.syncFunction(e.uniforms, t, n, r), !0;
  }
...
function ge(s, e) {
  if (!b.has(s)) {
    const t = new m({
      ...
      b.get(s) === t && b.delete(s);
    };
    t.once("destroy", r), t.source.once("destroy", r), b.set(s, t);
  }
  return b.get(s);
}
function dt(s) {
...
class Ft {
  ...
  bind(e, t = !0, r, a) {
    ...
    if (!a && e instanceof m && (a = e.frame), a) {
      ...
      u.x = a.x * p + 0.5 | 0, u.y = a.y * p + 0.5 | 0, u.width = a.width * p + 0.5 | 0, u.height = a.height * p + 0.5 | 0;
    } else
    ...
    return lt(
      ...
      !n.isRoot
    ), this.adaptor.startRenderPass(n, t, r, u), i && this.onRenderTargetChange.emit(n), n;
  }
  clear(e, t = U.ALL, r) {
  ...
  _initRenderTarget(e) {
    let t = null;
    return A.test(e) && (e = ge(e).source), e instanceof G ? t = e : e instanceof S && (t = new G({
      colorTextures: [e]
    }), A.test(e.source.resource) && (t.isRoot = !0), e.once("destroy", () => {
...
class ye {
  ...
  _addRenderableCacheAsTexture(e, t) {
    const r = e._batchableRenderGroup ?? (e._batchableRenderGroup = g.get(ue));
...
const ct = new P(), X = oe | ne | ie;
function Te(s, e = !1) {
  ht(s);
  const t = s.childrenToUpdate, r = s.updateTick++;
  for (const a in t) {
    const n = Number(a), i = t[a], o = i.list, l = i.index;
    for (let u = 0; u < l; u++) {
      const c = o[u];
      c.parentRenderGroup === s && c.relativeRenderGroupDepth === n && ke(c, r, 0);
    }
    D(o, l), i.index = 0;
  }
  if (e)
    for (let a = 0; a < s.renderGroupChildren.length; a++)
      Te(s.renderGroupChildren[a], e);
}
function ht(s) {
  const e = s.root;
  let t;
...
function ke(s, e, t) {
  ...
  const a = s.parent;
  if (a && !a.renderGroup ? (t |= s._updateFlags, s.relativeGroupTransform.appendFrom(
    r,
    a.relativeGroupTransform
  ), t & X && Q(s, a, t)) : (t = s._updateFlags, s.relativeGroupTransform.copyFrom(r), t & X && Q(s, ct, t)), !s.renderGroup) {
...
function Q(s, e, t) {
  ...
  t & ie && (s.groupBlendMode = s.localBlendMode === "inherit" ? e.groupBlendMode : s.localBlendMode), t & oe && (s.globalDisplayStatus = s.localDisplayStatus & e.globalDisplayStatus), s._updateFlags = 0;
}
function ft(s, e) {
...
class Ce {
  ...
  render({ container: e, transform: t }) {
    ...
    }), I(e.renderGroup, o), o.uniformBatch && o.uniformBatch.renderEnd(), t && e.renderGroup.localTransform.copyFrom(i), e.parent = r, e.renderGroup.renderGroupParent = a;
  }
  destroy() {
    this._renderer = null;
  }
    ...
    if (e.invalidateMatrices(), e.isCachedAsTexture) {
      if (e.textureNeedsUpdate) {
        ...
        e.texture = y.getOptimalTexture(
          ...
          i,
          o
        ), e._textureBounds || (e._textureBounds = new F()), e._textureBounds.copyFrom(r), a !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = !0);
      }
    } else e.texture && (y.returnTexture(e.texture), e.texture = null);
  }
  _updateRenderGroups(e) {
    const t = this._renderer, r = t.renderPipes;
    if (e.runOnRender(), e.instructionSet.renderPipes = r, e.structureDidChange ? D(e.childrenRenderablesToUpdate.list, 0) : ft(e, r), Te(e), e.structureDidChange ? (e.structureDidChange = !1, rt(e, t)) : this._updateRenderables(e), e.childrenRenderablesToUpdate.index = 0, t.renderPipes.batch.upload(e.instructionSet), !(e.isCachedAsTexture && !e.textureNeedsUpdate))
      for (let a = 0; a < e.renderGroupChildren.length; a++)
        this._updateRenderGroups(e.renderGroupChildren[a]);
  }
...
const L = class Se {
  constructor() {
    this.clearBeforeRender = !0, this._backgroundColor = new le(0), this.color = this._backgroundColor, this.alpha = 1;
  }
  /**
...
class we {
  ...
  _beginAdvancedBlendMode(e) {
    ...
    r || (r = this._filterHash[t] = new re(), r.filters = [new T[t]()]);
    const a = {
      renderPipeId: "filter",
      action: "pushFilter",
      renderables: [],
...
const B = {
  ...
  async base64(e) {
    ...
    if (a.toDataURL !== void 0)
      return a.toDataURL(B[t], r);
    if (a.convertToBlob !== void 0) {
      const n = await a.convertToBlob({ type: B[t], quality: r });
  ...
  pixels(e) {
    ...
    return t instanceof P && a.destroy(!0), n;
  }
  /**
...
class Re {
  ...
  generateTexture(e) {
    ...
    let n = e.clearColor;
    n ? n = Array.isArray(n) && n.length === 4 ? n : le.shared.setValue(n).toArray() : n = _t;
    const i = e.frame?.copyTo(gt) || je(a, xt).rectangle;
...
class Be {
  ...
  bind({
    ...
    let h;
    this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(u, !1) : (h = this._bindGroupPool.pop() || new qe(), this._activeBindGroups.push(h), h.setResource(u, 0)), l.bindGroup = h, this._currentGlobalUniformData = l;
  }
  push(e) {
    this.bind(e), this._globalUniformDataStack[this._stackIndex++] = this._currentGlobalUniformData;
  }
  pop() {
    this._currentGlobalUniformData = this._globalUniformDataStack[--this._stackIndex - 1], this._renderer.type === O.WEBGL && this._currentGlobalUniformData.bindGroup.resources[0].update();
  }
  get bindGroup() {
...
function yt(s) {
  if (!Z) {
    if (de.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
      const e = [
...
class W {
  ...
  init(e) {
    if (e.hello) {
      ...
      this._renderer.type === O.WEBGL && (t += ` ${this._renderer.context.webGLVersion}`), yt(t);
    }
  }
}
W.extension = {
  ...
  run() {
    ...
    for (let n = 0; n < t.length; n++) {
      ...
      if ((o?.gcTick ?? 0) === l && (i._lastUsed = e), e - i._lastUsed > this.maxUnusedTime) {
        if (!i.destroyed) {
          const u = r;
          o && (o.structureDidChange = !0), u[i.renderPipeId].destroyRenderable(i);
        }
        i._lastUsed = -1, a++, i.off("destroyed", this._removeRenderable, this);
      } else
        t[n - a] = i;
    }
    t.length -= a;
...
const N = class Ge {
  ...
  init(e) {
    e = { ...Ge.defaultOptions, ...e }, this.checkCountMax = e.textureGCCheckCountMax, this.maxIdle = e.textureGCAMaxIdle ?? e.textureGCMaxIdle, this.active = e.textureGCActive;
  }
  /**
...
const j = class Ie {
  ...
  init(e) {
    e = {
      ...Ie.defaultOptions,
      ...e
    }, e.view && (Ke(Ye, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new w(0, 0, e.width, e.height), this.canvas = e.canvas || de.get().createCanvas(), this.antialias = !!e.antialias, this.texture = ge(this.canvas, e), this.renderTarget = new G({
